...
class FedSagePlusClient(Client):
    def __init__(self,
        ...
        self.data = data
        # self.info_path=self._cfg.data.root+self._cfg.federate.method+"_"+self._cfg.data.type+ \
        #                "_M"+str(self._cfg.federate.client_num)+"_"+str(ID)+"_info.pkl"
        self.info_path=None
        self.hide_data = HideGraph(self._cfg.fedsageplus.hide_portion,info_path=self.info_path)(data)
        self.device = device
